...
public class CharacterController_2D : MonoBehaviour {
    ...
    public int Current_OrderinLayer = -2;  // 2depth ;
    ...
    void Start () {
        ...
        for (int i = 0; i < m_SpriteGroup.Length; i++)
        {
            ...
            m_SpriteGroup[i].sortingOrder = Current_OrderinLayer;
	...
	void Update () {
      ...
      //  spriteOrder_Controller();
        ...
        if (PressE_Obj.activeSelf && Input.GetKeyDown(KeyCode.E))
        {
    ...
    void Filp()
    {
        ...
        m_canvas.transform.localScale = theScale;
